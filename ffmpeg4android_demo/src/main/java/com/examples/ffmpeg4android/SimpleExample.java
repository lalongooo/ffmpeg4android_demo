...
public class SimpleExample extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        demoVideoPath = demoVideoFolder + "cin.mp4";
        ...
        invoke = (Button) findViewById(R.id.invokeButton);
        invoke.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Log.i(Prefs.TAG, "run clicked.");
                if (GeneralUtils.checkIfFileExistAndNotEmpty(demoVideoPath)) {
                    new TranscdingBackground(SimpleExample.this, commandText.getText().toString()).execute();
                } else {
    ...
    public class TranscdingBackground extends AsyncTask<String, Integer, Integer> {
        ...
        public TranscdingBackground(Activity act, String command) {
            _act = act;
